export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'og:url', property: 'og:url', content: 'https://ta1uchida.com' },
      {
        hid: 'og:title',
        property: 'og:title',
        content: "Taichi Uchida's Portfolio",
      },
      {
        hid: 'og:description',
        property: 'og:description',
        content: 'Visual Artist / Programmer in Japan.',
      },
  ...
  plugins: ['@/plugins/persistedstate.js', '@/plugins/lazyload.js'],
