<template>
    <div id="works">
        ...
        <div class="works_container">
            <div class="container">
                <div v-for="(work, index) in works" :key="work.key" class="work">
...
export default class Works extends Vue {
    ...
    getWorks(): void {
        ...
        .then(() => {
            ...
            localStorage.setItem('works', JSON.stringify(worksStore.works));
        })
        .catch((err) => {
            console.error(err);
        });
    ...
    created() {
        if (!JSON.parse(<string>localStorage.getItem('works')) || !localStorage.works) {
            this.getWorks();
        } else {
            this.works = JSON.parse(<string>localStorage.getItem('works'));
        }
    }
